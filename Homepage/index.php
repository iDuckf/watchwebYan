...
<?php
    ...
    $queryGoing = "SELECT * FROM tb_infor WHERE stat = 'On-Going'";
    $sqlGoing = mysqli_query($conn, $queryGoing);

    $queryComp = "SELECT * FROM tb_infor WHERE stat = 'Complete'";
    $sqlComp = mysqli_query($conn, $queryComp);
?>
...
<body>
    ...
    <div class="container-fluid bgContent">
        <div class="container content">
            ...
            <div class="row">
                <?php
                    while ($resGoing = mysqli_fetch_assoc($sqlGoing)) {
                ?>
                    <div class="col-2">
                        <div class="row">
                            <div class="col-12 text-center bgJudulCont">
                                <h4><?php echo $resGoing['judul']; ?></h4>
                            </div>
                        </div>
                        <img src="../img/<?php echo $resGoing['cover']; ?>" class="img-fluid my-1">
                        <div class="text-center">
                            <a href="../MainMenuAnime/index.php?anime=<?php echo $resGoing['judul']; ?>" class="aBtn">
            ...
            <div class="row">
                <?php
                    while ($resComp = mysqli_fetch_assoc($sqlComp)) {
                ?>
                    <div class="col-2">
                        <div class="row">
                            <div class="col-12 text-center bgJudulCont">
                                <h4><?php echo $resComp['judul']; ?></h4>
                            </div>
                        </div>
                        <img src="../img/<?php echo $resComp['cover']; ?>" class="img-fluid my-1">
                        <div class="text-center">
                            <a href="../MainMenuAnime/index.php?anime=<?php echo $resComp['judul']; ?>" class="aBtn">
                                <button class="btnWatch">
                                    <i class="fa fa-play-circle"></i>
                                    Watch
                                </button>
